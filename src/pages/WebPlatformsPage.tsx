...
const WebPlatformsPage = () => {
  return (
    <div className="bg-black text-white min-h-screen pt-32 pb-20 px-6 md:px-12 selection:bg-white selection:text-black">
      <SEO 
        title="Web Platforms | VELIX Tech"
        description="Lightning-fast, immersive landing pages and full-scale enterprise CMS solutions."
        url="https://www.velixinfo.tech/services/web-platforms"
      />
      ...
      <div className="max-w-[1200px] mx-auto">
        <motion.div
          ...
          className="mb-20"
        >
          <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mb-4 block">Service / 02</span>
          <h1 className="text-5xl md:text-[6rem] lg:text-[8rem] font-display font-black uppercase tracking-tighter leading-none mb-8">
            Web<br/><span className="text-zinc-500 italic">Platforms.</span>
          </h1>
          <p className="max-w-2xl text-xl md:text-2xl text-zinc-400 font-light leading-relaxed">
            Lightning-fast, immersive landing pages and full-scale enterprise CMS solutions. Built on modern stacks capable of handling massive scale.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 border-t border-zinc-800 pt-16">
          <div>
            ...
            <p className="text-zinc-400 leading-relaxed text-lg">
              We leverage modern web technologies (React, Next.js, and Node) to deliver ultra-fast static and dynamic web experiences. Security, performance, and accessibility are embedded directly into our development lifecycle from day one.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            {["High-Performance Landing Pages", "Enterprise CMS Integrations", "E-Commerce Solutions", "Progressive Web Apps (PWA)"].map((item, i) => (

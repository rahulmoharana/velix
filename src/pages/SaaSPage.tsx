...
const SaaSPage = () => {
  return (
    <div className="bg-black text-white min-h-screen pt-32 pb-20 px-6 md:px-12 selection:bg-white selection:text-black">
      <SEO 
        title="SaaS Infrastructure | VELIX Tech"
        ...
        url="https://www.velixinfo.tech/services/saas"
      />
      ...
      <div className="max-w-[1200px] mx-auto">
        <motion.div
          ...
          className="mb-20"
        >
          <span className="text-[10px] font-mono text-zinc-500 uppercase tracking-widest mb-4 block">Service / 03</span>
          <h1 className="text-5xl md:text-[6rem] lg:text-[8rem] font-display font-black uppercase tracking-tighter leading-none mb-8">
            SaaS<br/><span className="text-zinc-500 italic">Infrastructure.</span>
          </h1>
          <p className="max-w-2xl text-xl md:text-2xl text-zinc-400 font-light leading-relaxed">
            Robust end-to-end software development. We build the architecture, APIs, and front-end tools that power next-generation startups.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 border-t border-zinc-800 pt-16">
          <div>
            ...
            <p className="text-zinc-400 leading-relaxed text-lg">
              Building a SaaS platform requires a distinct mindset. Emphasizing multi-tenant architecture, robust database schemas, and highly scalable cloud infrastructure, we partner closely with founders to turn complex logic into a beautifully simple product tool.
            </p>
          </div>
          <div className="flex flex-col gap-6">
            {["Multi-Tenant Database Design", "Microservices & Serverless", "Complex API Architectures", "Secure User Auth & ACL"].map((item, i) => (
